...
The required packages are listed below, but are also included in a requirements.txt file so that running the following will automatically install them:
`pip install -r requirements.txt`
(I've included that line of code inside of each notebook - commented out)

Required packages:
`numpy, pandas, matplotlib, openpyxl, squarify`

NOTE: This was built with Python 3.13.5 and Jupyter Notebook 7.4.5
